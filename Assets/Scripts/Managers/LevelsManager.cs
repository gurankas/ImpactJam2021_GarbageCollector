...
public class LevelsManager : MonoBehaviour
{
    ...
    private void Awake()
    {
        LevelInfo newLevel = new LevelInfo("Level 1", "Let's start with the basics! Remember how to dispose these materials, then press Play whenever you're ready.", 10f);
